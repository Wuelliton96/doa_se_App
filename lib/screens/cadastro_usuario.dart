...
class _CadastroState extends State<Cadastro> {
  ...
  void initState() {
    ...
    // Recupere as informações do usuário e preencha os controladores
    _recuperarInformacoesUsuario();
  }
    ...
    try {
      ...
      if (user != null) {
        ...
        DocumentSnapshot<Map<String, dynamic>> snapshot =
            await db.collection('cadastro_user').doc(idUser).get();
        if (snapshot.exists) {
          Map<String, dynamic> userData = snapshot.data()!;
          _nomeCompletoController.text = userData['nomeCompleto'];
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: inputDecoration.copyWith(
                            hintText: '', labelText: 'Confirmar Senha'),
                        obscureText: true,
                        validator: (String? value) {
                          if (value == null) {
                            // Condicional que não pode ser apagado
                      ...
                      if (erro == true) {
                        ...
                        _usuarioModel
                          ...
                          if (erro != null) {
                            mostrarMensagem(
                                context: context,
                                texto: "Esse e-mail já está em uso!");
                          } else {
                            _usuarioModel
                                .salvarDados(
                                    email: email,
                              ...
                              if (erro != null) {
                                mostrarMensagem(
                                    context: context,
                                    texto: "Cadastro inválido!");
                              }
                            });
                            _usuarioModel.enviarLinkParaEmail(email);
                            fazerUploadImagem();
